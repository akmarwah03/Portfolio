  ...
  return (
    <Element name="connect" className="overflow-hidden">
      <Fade bottom duration={600} distance="70px" className="overflow-hidden">
        <div className="w-screen py-20 overflow-hidden bg-green-100 md:py-28">
          <div className="w-9/12 gap-20 mx-auto lg:grid lg:grid-cols-3">
            <div className="md:col-span-1">
              <h1 className="relative overflow-hidden text-3xl font-semibold text-center text-green-500 md:text-3xl md:w-max md:text-left">
            ...
            <div className="col-span-2">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-40 px-4 py-3 text-white bg-green-500 rounded-lg place-self-center md:place-self-start"
                >
                  SEND MESSAGE
                </button>
              </form>
